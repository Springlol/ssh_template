...
public class BaseAction extends ActionSupport {
	 ...
	 * 将对象转换成JSON字符串，并输出
	 *
	 * @param object    object 要输出的对象
	 * @param formatStr 输出时间格式
	 * @param args
	 */
	public void writeJsonByFilterAndFormateStr(Object object, String formatStr, String... args) {
		WebUtil.writeJsonByFilter(object, formatStr, args);
	}
