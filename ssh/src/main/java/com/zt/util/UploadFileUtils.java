...
public class UploadFileUtils {
	 ...
	 */
	public static String getFullNameByDirKey(String directroyKey, String fileName) {
	 ...
	 */
	public static void saveUploadFileByDirKey(String targetDirKey, String targetFileName, File srcFile) throws IOException {
	 ...
	 */
	public static void copyFile(File srcFile, String targetPathName) throws IOException {
		if (!srcFile.exists()) {
	 ...
	 *
	 * @param sourcePathName 原文件夹文件
	 * @param targetPathName 目标文件夹文件
	 * @throws IOException {@link #copyFile(File, String)}
	 */
	public static void copyFile(String sourcePathName, String targetPathName) throws IOException {
	 ...
	 * @throws NullPointerException {@link #getFullNameByDirKey(String, String)}
	 */
	public static File getFileByDirKey(String directroyKey, String fileName) {
		File file = new File(getFullNameByDirKey(directroyKey, fileName));
		if (!file.exists()) {
			file = ResourceUtils.getResourceFile("others/sorry.png");
		}
		return file;
	}
	 ...
	 */
	public static boolean deleteFileByDirKey(String directroyKey, String fileName) throws IOException {
	 ...
	 */
	public static void moveFile(String sourceDirectroyKey, String targetDirectroyKey, String sourceFileName) throws IOException {
	 ...
	 */
	public static void moveFile(String sourceDirectroyKey, String targetDirectroyKey, String sourceFileName, String targetFileName) throws IOException {
	 ...
	 */
	public static void moveFolder(String sourceDirectroyKey, String targetDirectroyKey, String sourceFolderName, String targetFolderName) throws IOException {
